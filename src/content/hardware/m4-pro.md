...
At 24 GB you can keep one 13–14B model loaded and hot-swap between them. Bump to 48 GB and you can keep two 13–14B models in memory simultaneously, useful if your workflow switches between a drafting model (Qwen3 14B) and a reasoning model (DeepSeek-R1 14B) throughout the day.

The 48 GB configuration also runs **Mistral Small 3 22B**, Mistral's current mid-size flagship, which approaches 70B quality on structured tasks while loading in ~15 GB.
